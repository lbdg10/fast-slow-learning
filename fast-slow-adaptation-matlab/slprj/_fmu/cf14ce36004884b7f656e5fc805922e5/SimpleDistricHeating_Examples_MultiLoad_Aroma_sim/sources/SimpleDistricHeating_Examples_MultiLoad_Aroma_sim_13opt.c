...
extern "C" {
#endif
int SimpleDistricHeating_Examples_MultiLoad_Aroma_sim_mayer(DATA* data, modelica_real** res,short *i) {
...
int SimpleDistricHeating_Examples_MultiLoad_Aroma_sim_lagrange(DATA* data, modelica_real** res, short * i1, short*i2) {
  throwStreamPrint(NULL, "The model was not compiled with -g=Optimica and the corresponding goal function. The optimization solver cannot be used.");
  return 0;
}
